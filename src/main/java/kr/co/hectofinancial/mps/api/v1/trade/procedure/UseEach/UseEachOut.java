...
public class UseEachOut {
    ...
    @Builder
    public UseEachOut(Long outResCd, String outResMsg, Long outMnyAmt, Long outPntAmt, Long outMnyBlc, Long outPntBlc, Long outWaitMnyBlc) {
