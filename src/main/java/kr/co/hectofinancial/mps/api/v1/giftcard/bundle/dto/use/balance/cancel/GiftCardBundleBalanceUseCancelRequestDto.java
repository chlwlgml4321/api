package kr.co.hectofinancial.mps.api.v1.giftcard.bundle.dto.use.balance.cancel;
...
@AllArgsConstructor
@NoArgsConstructor
public class GiftCardBundleBalanceUseCancelRequestDto {
    ...
    @JsonProperty("orgDstbTrdNo")
    private String orgDstbTrdNo; // 원거래 승인 번호

    @HashField(order = 5)
    @NotBlank(message = "원거래 승인 일자")
    @JsonProperty("orgTrdDt")
    private String orgTrdDt; // 원거래 승인 일자
