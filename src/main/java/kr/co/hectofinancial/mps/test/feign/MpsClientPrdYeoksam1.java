...
@FeignClient(name = "mpsClientPrdYeoksam1", url = "${feign.client.setting.url-prd-yeoksam1:defaultValue}", configuration = FeignClientConfig.class)
public interface MpsClientPrdYeoksam1 {
    ///////////////////////지갑
    /**
     * 사용
     *
