...
import kr.co.hectofinancial.mps.api.v1.trade.dto.TradeInfoListRequestDto;
import kr.co.hectofinancial.mps.api.v1.trade.dto.TradeInfoRequestDto;
import kr.co.hectofinancial.mps.api.v1.trade.dto.TradeUseSummaryRequestDto;
...
@FeignClient(name = "mpsClientTb", url = "${feign.client.setting.url-tb:defaultValue}", configuration = FeignClientConfig.class)
public interface MpsClientTb {
    ///////////////////////지갑
    /**
     * 사용
     *
