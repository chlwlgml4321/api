...
@FeignClient(name = "mpsClientPrdYeoksam2", url = "${feign.client.setting.url-prd-yeoksam2:defaultValue}", configuration = FeignClientConfig.class)
public interface MpsClientPrdYeoksam2 {
    ///////////////////////지갑
    /**
     * 사용
     *
