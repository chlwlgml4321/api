...
@Table(name = "TB_DSTB_DPMN_RCV_DTL", schema = "MPS")
@IdClass(DstbDpmnRcvDtlPK.class)
public class DstbDpmnRcvDtl {
    ...
    @Builder
    public DstbDpmnRcvDtl(String trdDt, String mid, String dpNotiNo, String dpDt, long dpAmt, String rmk, LocalDateTime createdDate, String createdId, String createdIp, LocalDateTime modifiedDate, String modifiedId, String modifiedIp){
        this.trdDt = trdDt;
        this.mid = mid;
        this.dpAmt = dpAmt;
