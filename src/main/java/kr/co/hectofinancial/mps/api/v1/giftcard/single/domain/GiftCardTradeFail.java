...
@NoArgsConstructor
@Entity
@Table(name = "PM_MPS_GC_TRD_FAIL", schema = "MPS")
@IdClass(GiftCardTradeFailPk.class)
public class GiftCardTradeFail {
    ...
    @Column(name = "FAIL_TM", nullable = false)
    ...
    @Column(name = "BNDL_GC_NO_ENC")
    private String bndlGcNoEnc;
}
