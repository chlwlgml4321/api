...
public class WithdrawalImpl implements Withdrawal {
    ...
    private final String WITHDRAWAL = " MPS.PKG_MPS_CUST_WLLT_V2.USE";
    @PersistenceContext
    private EntityManager entityManager;

    @Override
    public WithdrawalOut withdrawal(WithdrawalIn params) {

        StoredProcedureQuery query = entityManager.createStoredProcedureQuery(WITHDRAWAL);
        ...
        //Out 변수
        Arrays.stream(WithdrawalOut.class.getDeclaredFields())
                .forEach(field -> {
                    field.setAccessible(true);
