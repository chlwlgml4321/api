...
@FeignClient(name = "mpsClientPrdSongdo1", url = "${feign.client.setting.url-prd-songdo1:defaultValue}", configuration = FeignClientConfig.class)
public interface MpsClientPrdSongdo1 {
    ///////////////////////지갑
    /**
     * 사용
     *
