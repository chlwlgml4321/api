...
@FeignClient(name = "mpsClientPrdSongdo2", url = "${feign.client.setting.url-prd-songdo2:defaultValue}", configuration = FeignClientConfig.class)
public interface MpsClientPrdSongdo2 {
    ///////////////////////지갑
    /**
     * 사용
     *
